...
public class DocumentZStoreImplTest {
    ...
    public void stage4TestUndoAfterMaxDocCount() throws IOException {
        ...
        assertTrue(store.deleteDocument(this.uri2));
        assertTrue(store.deleteDocument(this.uri3));
        assertFalse(store.deleteDocument(this.uri4));
    }
    ...
    public void stage3Search() throws IOException {
        ...
        List<Document> results = this.search(store,"plain",2);
    ...
    public void stage3SearchTxtByPrefix() throws IOException {
        DocumentStore store = this.getStoreWithTextAdded();
        this.stage3SearchByPrefix(store);
        Set<URI> uris = store.deleteAll("text");
        assertEquals(4, uris.size());
    }
