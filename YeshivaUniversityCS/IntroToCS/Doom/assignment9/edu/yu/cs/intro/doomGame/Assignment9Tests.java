...
public class Assignment9Tests {
    ...
    public void testCanKill(){
        ...
        if(!GameBot.canKill(p,imp,fearsome)){
            System.out.println("TestCanKill with IMP and the result of canKill is: " + GameBot.canKill(p,imp,fearsome) );
        ...
        if(GameBot.canKill(p,demon,fearsome)){
            throw new IncorrectBehaviorException("GameBot.canKill returned true for a player being able to kill a demon even though he doesn't have the weapons and ammo needed to kill his protectors" );
        }
    ...
    public void testGetCompletedRooms(){
        ...
        // System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        // System.out.println("Currently Testing: testGetCompletedRooms");
        // for(Room room : bot.getAllRooms())
        // {
        //     System.out.println("The Room: " + room.getName() + " has a dangerLevel of " + room.getDangerLevel());
        // }
        boolean pl = bot.play();
        // System.out.println("bot.play evaluated to: " + pl);
        ...
        if(rooms.size() != 2 ||
            ...
            // System.out.println(findRoomByName(rooms,"Easy Imps"));
            // System.out.println(findRoomByName(rooms,"Double Demonic"));
